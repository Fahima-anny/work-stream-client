    ...
    return (
        <div>
               ...
               <div className="text-center mx-auto max-w-4xl">
                            ...
                            <p className="text-gray-500">Our mission is to simplify employee management, enhancing productivity, fostering collaboration, and delivering innovative solutions for workplace success .</p>
                        </div>
            
<div className="flex flex-col md:flex-row gap-10 pt-10 items-center">

{/* card 1 */}
<div className="card md:w-1/3 shadow-md px-3 py-5 shadow-gray-500 lg:h-[300px]">
...
{/* card 2 */}
<div className="card md:w-1/3 shadow-md px-3 py-7 shadow-gray-500 lg:h-[300px]">
  ...
  <div className="card-body p-0 items-center text-center">
    ...
    <p className="text-gray-500">We prioritize customer satisfaction, foster trust, embrace diversity, and empower businesses to achieve their goals with streamlined and effective workforce management solutions.</p>
    <div className="card-actions">
   <button></button>
    </div>
  </div>
