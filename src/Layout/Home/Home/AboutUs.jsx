...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pb-20">
  ...
  <h3 className="w-fit bg-blue-100 border border-blue-700 rounded-lg py-1 px-2 text-blue-600 font-semibold flex items-center"><TiArrowForward className="text-2xl" /> About Us </h3>
                            ...
                            <Link to='/about' className="btn mt-5 bg-white hover:bg-blue-100 duration-300 border rounded-md font-semibold border-blue-700 text-blue-700 flex gap-2 justify-start w-fit">View Details <IoIosArrowForward /></Link>
  </div>
</div>
